...
void Noh::DesalocarRecursivo() {
    if(this->mEsq == NULL and this->mDir == NULL){
        delete this;
    }
    else{
        if(this->mEsq != NULL){
...
Noh* Noh::Tio() {
    if(this->mPai == this->mPai->mPai->mEsq and this->mPai->mPai->mDir != NULL){
        return this->mPai->mPai->mDir;
    }else if(this->mPai == this->mPai->mPai->mDir and this->mPai->mPai->mEsq != NULL){
